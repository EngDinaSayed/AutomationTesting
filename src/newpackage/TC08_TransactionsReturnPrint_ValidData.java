...
public class TC08_TransactionsReturnPrint_ValidData {
	...
	public static void main(String[] args) {
		...
		driver.get("http://localhost:8080/library-master/member/return.php");
		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		
		driver.findElement(By.xpath("//div[@class='span12']//div[@class='pull-right']")).click();
