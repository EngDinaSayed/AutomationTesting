...
public class TC11_TransactionsBorrowedSearch_ValidData {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//div[@id='example_filter']//label//input[@type='text']")).sendKeys("jahidd26@gmail.com");;
